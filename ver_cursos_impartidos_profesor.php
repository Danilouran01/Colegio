...
<form action="ver_cursos_imparatidos_profesor.php">
    ...
    <?php
     ...
     $query=" SELECT profesor.id_profesor,CONCAT(profesor.nombre, ' ',profesor.apellido) AS nom, curso.nombre_curso,curso.jornada FROM profesor INNER JOIN profesor_curso on profesor.id_profesor=profesor_curso.id_profesor INNER JOIN curso on profesor_curso.codigo_curso=curso.codigo_curso WHERE profesor.id_profesor='$user';";
